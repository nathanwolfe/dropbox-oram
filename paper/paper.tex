...
\textbf{Organization.} 
We will first provide some background on Path ORAM in Section \textcolor{red}{add section label and reference}. We will then explain the system architecture behind our ORAM implementation in Section \textcolor{red}{3}. Then, after explaining our various optimizations and improvements in Section \textcolor{red}{4}, we will present some evaluations results in Section \textcolor{red}{5}.
